...
const quoteApiUrl = "http://api.quotable.io/random?minLength=100&maxLength=100" ;
...
userInput.addEventListener("input", () => {
    ...
    //create an array from recevied span tags
    ...
    quoteChars.forEach((char,index) =>{
        ...
        //If user entered wrong character
            ...
            //checkif if we already have added fail class
